...
write.table.bare <- write.table %^% list(quote=F, row.names=F, col.names=F)
...
'
function write.table.bare : data frame

        Specializatoin of write.table: no quoted strings, no row
