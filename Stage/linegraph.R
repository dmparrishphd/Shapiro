...
# LICENCE DETAILS PRESENTED BELOW
...
'                            linegraph
            ...
            THE INTENDED PURPOSE of linegraph is to
            produce a new graph on the current
            device. Other uses are possible.
    ...
    *except* the data to be plotted.
    ...
    2019-08-06:
            Added par.mai and associated behavior.
            Cleaned code.
