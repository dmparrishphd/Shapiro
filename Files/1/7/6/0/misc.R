...
odds <- evens %O% pred #TAGS sequences

    Doc$odds <- '
        odds returns the first n odd numbers, where n is arg 1.

        HISTORY
        
        2019-08-01: Corrected. previously returned the
                    first n - 1 even numbers.
        '
